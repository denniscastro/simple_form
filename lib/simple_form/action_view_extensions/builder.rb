    ...
    module Builder
      ...
      def collection_radio(attribute, collection, value_method, text_method, options={}, html_options={})
        render_collection(
          ...
          label(sanitize_attribute_name(attribute, value), text, :class => "collection_radio") + "<br/>".html_safe +
      ...
      def collection_check_boxes(attribute, collection, value_method, text_method, options={}, html_options={})
        render_collection(
          ...
          default_html_options[:multiple] = true
            ...
            label(sanitize_attribute_name(attribute, value), text, :class => "collection_check_boxes") + "<br/>".html_safe +
